...
class AddRemoveMovieToFavoriteUseCase @Inject constructor(
    private val movieRepository: MovieRepository
) {
    suspend operator fun invoke(movie: Movie): Flow<Movie> {
        return flowOf(movieRepository.addRemoveMovieFavorite(movie))
    }
}